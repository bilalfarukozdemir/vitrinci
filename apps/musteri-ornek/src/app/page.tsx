...
export default function Sayfa() {
  ...
  return (
    <>
      ...
      {/*
         OLANAKLAR — konaklamanin menu karsiligi, hizmet kartlarinin
         hemen altinda. Kart anlatir ("dere kenarinda ahsap evler"),
         olanak listesi CEVAPLAR ("somine · jakuzi · kahvalti dahil").
         Rezervasyon dusunen insanin telefonda soracagi sorularin
         yazili hali — o yuzden iletisimden ONCE geliyor.
      */}
      {demo.olanaklar && demo.olanaklar.length > 0 && (
        <section className="bolum" id="olanaklar">
          <div className="sar">
            <h2>Olanaklar</h2>
            <ul className="olanaklar" role="list">
              {demo.olanaklar.map((o) => (
                <li key={o}>{o}</li>
              ))}
            </ul>
          </div>
